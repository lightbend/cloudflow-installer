...
The goal of these notes is to make your experience contributing to cloudflow as smooth and pleasant as possible. 
...
1. To avoid duplicated effort, it might be good to check the [issue tracker](https://github.com/lightbend/cloudflow-installer/issues) and [existing pull requests](https://github.com/lightbend/cloudflow-installer/pulls) for existing work.
   - If there is no ticket yet, feel free to [create one](https://github.com/lightbend/cloudflow-installer/issues/new) to discuss the problem and the approach you want to take to solve it.
...
1. If it's a new feature, or a change of behavior, document it on the [cloudflow-docs](https://github.com/lightbend/cloudflow-docs), remember, an undocumented feature is not a feature. If the feature was touching Scala or Java DSL, make sure to document both the Scala and Java APIs.
